          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-3">
              ...
              <input class="form-control form-control" type="date" id="data_nasc" name="data_nasc"
                max="<?php echo date('Y-m-d'); ?>" value="<?php echo htmlspecialchars($dados['data_nasc']); ?>"
                required>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-3">
              ...
              <input class="form-control form-control" type="tel" id="celular" name="celular"
                value="<?php echo htmlspecialchars($dados['celular']); ?>" oninput="formatarTelefone(this)" required>
            </div>
            <!-- Sexo -->
            <div class="col-lg-4 col-md-6 col-12 mb-3">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-3">
              ...
              <div class="d-flex align-items-center">
                ...
                <button type="button" class="btn btn-outline-secondary"
                  onclick="toggleSenha('confirma_senha')">Mostrar</button>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 mb-3 d-flex justify-content-center align-items-end">
